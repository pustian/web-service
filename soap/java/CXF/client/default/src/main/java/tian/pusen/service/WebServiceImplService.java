 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://service.pusen.tian/", wsdlLocation = "http://localhost:8080/WS_Server/Webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://service.pusen.tian/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WS_Server/Webservice?wsdl");
    ...
    public IWebService getWebServiceImplPort() {
        return super.getPort(new QName("http://service.pusen.tian/", "WebServiceImplPort"), IWebService.class);
    }
    ...
    public IWebService getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.pusen.tian/", "WebServiceImplPort"), IWebService.class, features);
    }
